...
class QuestionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['marks', 'exam_duration', 'question', 'option1', 'option2', 'option3', 'option4', 'answer']
        widgets = {
            'question': forms.Textarea(attrs={'rows': 3, 'cols': 50})
        }


# class ExamTimeField(forms.ModelForm):
#    model = models.ExamTime

#    class Meta:
#        fields = ['exam_duration']
